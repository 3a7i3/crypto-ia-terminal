...
class ModelDegradationMonitor:
    ...
    def check_staleness(self, component: str, max_age_hours: float = 24.0) -> bool:
        ...
        if age_hours > max_age_hours and last > 0:
            self._emit_alert(component, "stale", "info",
                             1.0, 1.0, 0.0,
                             f"{component} sans mise à jour depuis {age_hours:.1f}h", "alert_only")
            return True
        return False
    ...
    def _check_degradation(self, component: str, metric_name: str, key: str) -> None:
        ...
        self._emit_alert(
            component, "accuracy_drop", severity,
            recent, baseline, degradation,
