...
def load_advisor_runtime() -> AdvisorRuntime:
    ...
    from quant_hedge_ai.agents.execution.position_manager import PositionManager, Position
    from tracker_system.core.trade_tracker import finalize_position as tracker_finalize_position
    ...
    from quant_hedge_ai.agents.intelligence.self_awareness_engine import SelfAwarenessEngine, DangerLevel
    ...
    from quant_hedge_ai.agents.intelligence.decision_quality_engine import DecisionQualityEngine
