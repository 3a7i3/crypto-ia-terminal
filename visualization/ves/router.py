...
from visualization.ves.registry import get_renderer, VESError
...
class VisualizationEngine:
    ...
    def render_snapshot(self, viewer_level: int = V3) -> bytes:
        ...
        from visualization.api import load_health_snapshot, load_pipeline_snapshot, load_portfolio_snapshot
