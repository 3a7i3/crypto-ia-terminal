"""WEB-RL-01 passive Research Lab presentation artifact.

This module validates and publishes one presentation-only snapshot assembled
from already-certified Research evidence. It performs no scientific
performance calculation and imports no runtime/PPL/exchange machinery.
"""
...
def publish_research_lab_snapshot(path: str | Path, doc: Mapping[str, Any]) -> str:
    ...
    This writes only the requested presentation artifact. It never mutates
