...
def test_get_env_int_returns_default_when_missing() -> None:
    # Vérifie que la valeur par défaut est retournée si la variable d'environnement est absente
...
def test_get_env_float_returns_default_on_invalid_value() -> None:
    # Vérifie que la valeur par défaut est retournée si la variable n'est pas un float
...
def test_get_env_float_applies_bounds() -> None:
    # Vérifie que la borne max est appliquée
...
def test_get_env_bool_parsing() -> None:
    # Vérifie le parsing des booléens
...
def test_get_env_bool_invalid_falls_back_to_default() -> None:
    # Vérifie que la valeur par défaut est utilisée si la valeur n'est pas reconnue
...
def test_get_env_str_returns_trimmed_value_or_default() -> None:
    # Vérifie que la chaîne est bien trimée ou que la valeur par défaut est utilisée
...
def test_runtime_config_loads_new_decision_parameters() -> None:
    # Vérifie le chargement des nouveaux paramètres de décision
...
def test_runtime_config_clamps_new_decision_parameters() -> None:
    # Vérifie que les bornes sont bien appliquées
...
def test_runtime_config_loads_doctor_telegram_settings() -> None:
    # Vérifie le chargement des paramètres Telegram du doctor
