...
_REGIME_CONFIGS: dict[str, RegimeConfig] = {
    ...
    "sideways": RegimeConfig(
        ...
        sl_factor_atr=1.5,
        tp_factor_atr=float(os.getenv("REGIME_SIDEWAYS_TP_ATR", "1.0")),
        size_factor=0.7,
        trail_active=False,
        confirm_required=False,
        description="Range latéral — mean reversion, TP 1×ATR, SL 1.5×ATR",
    ),
    ...
    "RANGE": RegimeConfig(
        ...
        trail_active=False,
        confirm_required=False,
        description="Range latéral (packet) — mean reversion, TP 1×ATR, SL 1.5×ATR",
    ),
