"""Tests SystemIntelReporter — filtre CLEAN_DATA_SINCE (ADR-0011).
...
from tools.cri_calculator import CLEAN_DATA_SINCE

_AFTER = CLEAN_DATA_SINCE.timestamp() + 3600  # 1h après la borne
_BEFORE = CLEAN_DATA_SINCE.timestamp() - 3600  # 1h avant la borne
