...
class TestWhaleParser:
    ...
    def test_real_whale_alert_format(self):
        assert (
            LiquidityFlowMap._parse_whale_amount("OUTFLOW_FROM_EXCHANGE: 2.4M USD")
            == 2_400_000
        )

    def test_whale_transfer_format(self):
        assert (
            LiquidityFlowMap._parse_whale_amount("WHALE_TRANSFER: 4.4M USD on BTCUSDT")
            == 4_400_000
        )
...
class TestFlowReport:
    ...
    def test_as_dict_keys(self):
        ...
        expected_keys = {
            ...
            "top_sector_score",
            "total_volume_usd",
            "total_whale_flow_usd",
            "parsed_whale_alerts_usd",
            "whale_unmapped_usd",
            "whale_mapping_coverage",
            "whale_consistency_gap_usd",
